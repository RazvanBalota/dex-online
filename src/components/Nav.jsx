    ...
    <nav
      ...
      <div className="flex w-full justify-between text-secondary dark:text-secondaryDark ">
        <div className="flex gap-x-2 px-4 lg:px-0">
          <Link to="/dex-online">
            {theme === "light" ? (
              <img src={logo} alt=" " className="block lg:hidden w-[120px]" />
            ) : (
              <img src={logoDarkMode} alt=" " className="block lg:hidden w-[120px]" />
            )}
          </Link>
        ...
        <div className="flex  items-center gap-x-3 px-4 lg:px-0">
          ...
          <button
            onClick={openNav}
            className={`border-2 border-black/50 dark:border-white/50 w-[40px] h-[40px] lg:h-[0] lg:w-[0] flex justify-center items-center cursor-pointer ease-in-out delay-500"
            }`}>
